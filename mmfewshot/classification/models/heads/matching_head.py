...
class GMyBidirectionalLSTM(nn.Module):
    def __init__(self, input_size, hidden_size):
        super(GMyBidirectionalLSTM, self).__init__()
...
# Initialize the custom Bidirectional LSTM model
# input_size, hidden_size = 512, 512//2

g = GMyBidirectionalLSTM(512, 512 // 2).to(device)
